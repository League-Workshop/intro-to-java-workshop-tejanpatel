...
r2d2.microMove(5);
	...
	private void spaceBarWasPressed() {
		...
		System.out.print(robotxLocation);
		System.out.print(robotYLocation);
		// 7. If robot is at same location as the little girl
		//      --make a pop-up tell the robot where to go next
		if(robotxLocation==720 &&robotYLocation==410) {JOptionPane.showMessageDialog(null, "Now go to the empty eye of the skull?");}
		...
		if(robotxLocation==195&&robotYLocation==55) {treasureFound();}
	}
